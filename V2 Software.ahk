...
if (rand = 1) {
    ...
    GuiControl, CoinFlip:, CoinFlipOutput, Blue 🔵
}
return
...
if (rand = 1) {
    ...
    if (rand = 1) {
        ...
        GuiControl, Roulette:, RouletteOutput, BLUE 🔵
        GuiControl, Roulette:, RouletteOutput, Blue
    }
}
return
...
HitBlackjack:
    ; Your code for handling the Hit button click goes here
return

StandBlackjack:
    ; Your code for handling the Stand button click goes here
return

DoubleDownBlackjack:
    ; Your code for handling the Double Down button click goes here
return

SplitBlackjack:
    ; Your code for handling the Split button click goes here
return
